...
import { useRouter } from "next/navigation";
import { toast } from "@/lib/toast";
import { X, Upload, Hash, RefreshCcw, ImageIcon, Image as LucideImage } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        {/* Header */}
        <div className="flex justify-between items-center p-6 border-b bg-gradient-to-r from-slate-50 to-white relative overflow-hidden">
        ...
        <form onSubmit={submit} className="p-6 space-y-6">
            ...
            <div className="relative group border-2 border-dashed border-slate-200 rounded-2xl p-4 hover:border-blue-400 transition-all bg-slate-50 flex flex-col items-center justify-center min-h-[200px]">
              {preview ? (
                ...
                <div className="text-center">
                  ...
                  <p className="text-[10px] text-slate-400 mt-1 uppercase tracking-widest font-bold">PNG, JPG, or WEBP</p>
                </div>
              )}
              <input 
                type="file" 
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-8 py-2.5 bg-slate-900 text-white rounded-xl font-bold shadow-lg shadow-slate-200 hover:bg-black disabled:bg-slate-400 transition-all flex items-center gap-2 active:scale-95 cursor-pointer"
            >
              {loading ? (
                <>

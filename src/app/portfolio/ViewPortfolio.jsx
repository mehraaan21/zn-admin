        ...
        >
          ...
          >
            ...
            <div className="sticky top-2 z-20 p-8 border-b bg-white/90 backdrop-blur-md flex justify-between items-center overflow-hidden">
              ...
              <button
                onClick={onClose}
                className="p-2 hover:bg-slate-100 rounded-full transition-colors text-slate-400 hover:text-slate-600 cursor-pointer relative z-10"
              >
                <X size={24} />
              </button>
            </div>
                    ...
                    <div>
                      ...
                      {data.website_url ? (
                        <a
                          ...
                          target="_blank"
                          className="flex items-center justify-between p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-all shadow-lg shadow-blue-100 group"
                        >

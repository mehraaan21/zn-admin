...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: <Info size={18} />, label: "Testimonial" },
  ...
  const subMenus = {
    ...
    Testimonial: [{ label: "Testimonial Manage", path: "/testimonials" }],
    "Our Services": [{ label: "Services Manage", path: "/services" }],
    Portfolio: [{ label: "Portfolio Manage", path: "/portfolio" }],
  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-xs text-center text-gray-800 uppercase  mb-3 tracking-wide">
          Menu
        </div>
          ...
          {menuItems.map((item, index) => (
            <div key={index}>
              ...
              {openMenus[item.label] && subMenus[item.label] && (
                <div className="pl-10 pr-3 py-2 text-sm text-gray-600 hover:bg-gray-700 rounded-md dark:text-gray-300 space-y-2">

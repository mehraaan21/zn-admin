    ...
    <div className="max-w-7xl mx-auto py-12 px-6">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 cursor-pointer bg-blue-500 hover:bg-blue-600 text-white px-5 py-2.5 rounded-xl shadow transition active:scale-95"
        >
                ...
                <tr key={item.id} className="hover:bg-slate-50/50 transition">
                  ...
                  <td className="p-5">
                    <div className="flex justify-center gap-2">
                      <button onClick={() => setViewItem(item)} className="p-2 text-slate-400 bg-slate-200 cursor-pointer hover:bg-blue-50 rounded-full"><Eye size={18} /></button>
                      <button onClick={() => setEditItem(item)} className="p-2 text-blue-400 bg-blue-200 cursor-pointer hover:text-blue-600 hover:bg-orange-50 rounded-full"><Pencil size={18} /></button>
                      <button onClick={() => setDeleteId(item.id)} className="p-2 text-red-400 bg-red-200 cursor-pointer hover:text-red-600 hover:bg-red-50 rounded-full"><Trash2 size={18} /></button>
                    </div>
                  </td>
                </tr>
              ))

      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="flex flex-col items-center justify-center mb-2">
            <label className="text-sm font-semibold text-gray-700 mb-2 self-start">
              Technology Logo
            </label>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <button
              onClick={submit}
              disabled={loading}
              className="px-8 py-2.5 bg-blue-600 text-white rounded-lg font-bold shadow-lg shadow-blue-100 hover:bg-blue-700 disabled:bg-blue-300 transition-all flex items-center gap-2 active:scale-95"
            >
              {loading ? (
                <>

...
export default function DeleteTechStack({ id, onClose }) {
  ...
  const remove = async () => {
    try {
      ...
      toast("Technology removed from stack", "success");
      onClose();
      router.refresh();
    } catch (err) {
        ...
        <div className="p-8">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-slate-500 mt-2 text-sm leading-relaxed">
              Are you sure you want to remove this technology? This will delete the icon and record permanently from your tech stack list.
            </p>
          </div>

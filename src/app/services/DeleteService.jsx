...
export default function DeleteService({ id, onClose }) {
  ...
  const remove = async () => {
    try {
      ...
      toast("Service removed successfully", "success");
      router.refresh();
      onClose();
    } catch (error) {
        ...
        <div className="p-8">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-500 mt-2 text-sm leading-relaxed">
              Are you sure you want to remove this service? This action is permanent and will remove all descriptions, FAQs, and process steps associated with it.
            </p>
          </div>
